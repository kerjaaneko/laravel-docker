...
<footer class="footer-area clearfix" style="background-image: url({{asset('frontend/img/bg/footer.png')}})">
    ...
    <div class="footer-bottom-area">
        <p class="pt-3 text-center">Copyright &copy; {{date('Y')}} {{setting('title')}}. All Right Reserved | Repost by <a href='https://stokcoding.com/' title='StokCoding.com' target='_blank'>StokCoding.com</a>
        </p>
    </div>
</footer>
<!-- FOOTER END -->
